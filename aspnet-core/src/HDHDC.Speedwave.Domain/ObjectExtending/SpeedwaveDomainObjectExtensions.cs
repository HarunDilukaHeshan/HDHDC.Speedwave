...
namespace HDHDC.Speedwave.ObjectExtending
{
    public static class SpeedwaveDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the SpeedwaveEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
