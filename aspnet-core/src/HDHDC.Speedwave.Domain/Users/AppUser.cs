...
namespace HDHDC.Speedwave.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update SpeedwaveDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update SpeedwaveEfCoreEntityExtensionMappings to extend the IdentityUser entity
